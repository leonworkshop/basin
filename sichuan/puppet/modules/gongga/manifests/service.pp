...
class gongga::service inherits gongga {
  ...
  if $service_manage == true {
        ...
        supervisor::service {
            $service_name:
                ...
                directory         => '/',
# FIX it:
# gongga has to be start as "root" privilege. Didn't
...
#        group             => $group,
                ...
                require => [  Class['gongga::config'], Class['::supervisor'] ],
        }

        if $service_enable == true {
            exec { 'restart-gongga-worker':
